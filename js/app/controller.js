...
.controller("indexController",function($scope){
    $scope.titulo = "Home";
    $scope.alunos = [
        {nome: "Camila",email:"camila@mail.com",nota1:25,nota2:80,nota3:95},
        {nome: "Pedro",email:"pedro@mail.com",nota1:75,nota2:80,nota3:55},
        {nome: "Murilo",email:"murilo@mail.com",nota1:65,nota2:40,nota3:55},
        {nome: "João",email:"joao@mail.com",nota1:45,nota2:80,nota3:55},
        {nome: "Amanda",email:"amanda@mail.com",nota1:78,nota2:30,nota3:85}
    ];
